...
export type CatppuccinFlavorName = 'latte' | 'frappe' | 'macchiato' | 'mocha';

/** Latte — 浅色 flavor，低饱和暖白底。 */
export const latte: CatppuccinFlavor = {
    rosewater: '#dc8a78',
    flamingo: '#dd7878',
    pink: '#ea76cb',
    mauve: '#8839ef',
...
/** Frappé — 中等暗度 flavor，蓝灰底。 */
export const frappe: CatppuccinFlavor = {
    rosewater: '#f2d5cf',
    flamingo: '#eebebe',
    pink: '#f4b8e4',
    mauve: '#ca9ee6',
...
/** Macchiato — 深暗 flavor，比 Frappé 更深。 */
export const macchiato: CatppuccinFlavor = {
    rosewater: '#f4dbd6',
    flamingo: '#f0c6c6',
    pink: '#f5bde6',
    mauve: '#c6a0f6',
...
/** Mocha — 最深 flavor，高对比暗色。 */
export const mocha: CatppuccinFlavor = {
    rosewater: '#f5e0dc',
    flamingo: '#f2cdcd',
    pink: '#f5c2e7',
    mauve: '#cba6f7',
...
/** 按名称索引 flavor。 */
export const catppuccinFlavors = { latte, frappe, macchiato, mocha } as const;
