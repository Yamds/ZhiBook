...
/** 键盘字号 22px（本轮需求）；leading-none 避免被键高挤出。 */
const KEY_CLASS =
    'flex h-[58px] items-center justify-center rounded-md text-[22px] font-semibold leading-none text-text tabular-nums active:bg-inset';
const OPERATOR_CLASS =
    'flex h-[58px] items-center justify-center rounded-md text-[22px] font-medium leading-none text-text tabular-nums active:bg-inset';
